...
namespace FirmApi
{
    public class FirmApiDbContext : DbContext
    {
        // Employees entity mapping
        //  public virtual DbSet<Employees> Employees { get; set; }
        public FirmApiDbContext(DbContextOptions<FirmApiDbContext> options) : base(options)
        {
    ...
    {
        public static DbCommand LoadStoredProc(this FirmApiDbContext firmContext, string name)
        {
